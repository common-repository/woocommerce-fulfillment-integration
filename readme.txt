...
**NOTE: NOTE: WooCommerce has changed the way they handle order status in WooCommerce 2.2+. This plugin no longer has access to stock or custom order statuses. We have created a new integration module to work directly with the WooCommerce 2.2+ API, no plugin needed. Please visit [support.efulfillmentservice.com](https://support.efulfillmentservice.com/ "eFulfillment Support") to obtain instructions**
